...
{
	public sealed class ThreesomesGameService : BaseGameService<ThreesomesGame>, IGameService<ThreesomesGame>
	{
		private readonly ILogger<ThreesomesGameService> _logger;
		private readonly IPitchRepository _pitchRepository;
		private readonly IPlayerRepository _playerRepository;

		public ThreesomesGameService(ILogger<ThreesomesGameService> logger, IPitchRepository pitchRepository, IPlayerRepository playerRepository)
		{
			this._logger = logger;
		...
		protected override GameFormats GameFormat => GameFormats.Threesomes;
		...
		protected override async Task<Entities.Game.Game> InnerCreate(IPlayerMatchModel matchModel, GameResult gameResult)
		{
			...
			var gameData = new ThreesomesGame();
		...
		protected override async Task<Entities.Game.Game> InnerUpdate(IPlayerMatchModel matchModel, GameResult gameResult)
		{
			...
			var gameData = playerGame.Game as ThreesomesGame;
		...
		{
			this.GuardCheckPlayersCount(gameResult.HomePlayers, 3, "HomePlayers");
			this.GuardCheckPlayersCount(gameResult.AwayPlayers, 3, "AwayPlayers");
		}

		private void GuardCheckLoadedPlayerCounts(IEnumerable<Player> players)
		{
			this.GuardCheckPlayersCount(players, 6, "LoadedPlayers");
		}
